...
const IconComponent = (props: IconProps) => {
  ...
  return (
    <Svg width={size} height={size} fill="none" {...otherProps}>
      <Path stroke={color} d="M15 11H9" strokeLinecap="round" strokeWidth="2" />
      <Path
        stroke={color}
...
IconComponent.displayName = "ChatRemove";

export const ChatRemove: NamedExoticComponent<IconProps> =
